# -*- coding: utf-8 -*-
"""
Created on Sun May 25 19:04:51 2025
...
while True:
    ...
    # Run YOLO inference (but don't show YOLO label/output)
    results = yolo_model.infer(frame)[0]
    ...
    # Show the frame
    cv2.imshow("MobileNet + Color (YOLO Hidden)", frame)
